...
The latest pokepinball-compatible version of **rgbds** is  [**1.0.3**](https://github.com/gbdev/rgbds/releases/v1.0.3). To install, put each of the files in the download in `C:\cygwin\usr\local\bin`.
